...
namespace BlueCardPortal.Infrastructure.Migrations
{
    ...
    [Migration("20240816054210_UpdateMessage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlueCardPortal.Infrastructure.Data.Models.Application.ApplicationMessage", b =>
                {
                    ...
                    b.Property<byte[]>("RegistrationTimeStamp")
                        .HasColumnType("bytea")
                        .HasColumnName("registration_time_stamp");
            ...
            modelBuilder.Entity("BlueCardPortal.Infrastructure.Data.Models.Application.UpdateMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("SourceTypeId")
                        ...
                        .HasComment("Тип източник");

                    b.HasKey("Id")
                        .HasName("pk_update_messages");

                    b.ToTable("update_messages", null, t =>
                        {
                            t.HasComment("Подписани данни от саоотказ/жалба/промяна изпратени към коре системата");
                        });
                });
